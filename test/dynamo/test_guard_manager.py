...
print(guard_mananger.animesh.check(9), guard_mananger.animesh.check(11))




guard_mananger["foo"].add_lambda_guard(lambda x: isinstance(x, int))
guard_mananger["foo"].add_lambda_guard(lambda x: x <= 10)
guard_mananger["foo"].add_lambda_guard(lambda x: x >= 5)
print(guard_mananger["foo"].check(9), guard_mananger["foo"].check(11))
